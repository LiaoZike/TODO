...
@section('page-content')
    ...
    <div class="container-fluid px-4">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            ...
            <a class="btn btn-success btn-sm" href="{{ route('admin.tasks.create') }}" style="width:100%;padding:10px 0px;margin-bottom: 40px;">
        ...
        <table id="TaskTable" class="table" >
            ...
            <tr>
                ...
                <th>S_NewT</th>
                <th>S_Note</th>
                <th style="display: none;">hidden_function</th>
            </tr>
            </tfoot>
            <tbody>
            ...
            @foreach($tasks as $task)
                <tr>
                    ...
                    <td style="width: 150px">
                        <a href="{{ route('admin.tasks.edit',$task->id) }}" class="btn btn-primary btn-sm">編輯</a>
